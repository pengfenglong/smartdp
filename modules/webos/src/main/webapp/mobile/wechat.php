...
XML;
  ...
  class MyWechat extends Wechat {
	...
	public function run() {
	    ...
	    $mysql = new SaeMysql();
		$sql = "INSERT  INTO `wechat_message` ( `content`) VALUES ('"  . $GLOBALS['HTTP_RAW_POST_DATA'] . "') ";
		$mysql->runSql($sql);
		if ($mysql->errno() != 0)
		{
	  ...
	  $items = array(
        new NewsResponseItem('pengfenglong', '欢迎您的光临，请点击进入云主页!', 'http://file.apicloud.com/mcm/A6963902293644/b84b7f8d7172ad436f0edc87f8d420f8.jpg', 'http://pengfenglong.sinaapp.com?uid='.$this->getRequest('fromUserName')),
      );
  ...
  $wechat = new MyWechat('pengfenglong', TRUE);
  $wechat->run();
