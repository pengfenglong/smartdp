package com.smartdp.codegenerator.provider.db.model;
...
import com.smartdp.codegenerator.util.StringHelper;
...
public class Table {
	...
	public String getClassName() {
		String defaultValue = StringHelper.makeAllWordFirstLetterUpperCaseBy("table",StringHelper.toUnderscoreName(getSqlName()));
	...
	private List<ForeignKey> oneToMany = new ArrayList<ForeignKey>();
	...
	private List<ForeignKey> manyToOne = new ArrayList<ForeignKey>();
	...
	private List<ForeignKey[]> manyToMany = new ArrayList<ForeignKey[]>();
	public void setManyToMany(List<ForeignKey[]> manyToMany){
		this.manyToMany = manyToMany;
	}
	
	public List<ForeignKey[]> getManyToMany(){
		return manyToMany;
	}
