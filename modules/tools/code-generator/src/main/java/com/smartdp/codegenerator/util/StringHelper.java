package com.smartdp.codegenerator.util;
...
public class StringHelper {
	...
	public static String makeAllWordFirstLetterUpperCaseBy(String type,String sqlName){
		String[] strs = sqlName.toLowerCase().split("_");
		String result = "";
		String preStr = "";
		int n = 0;
		if("table".equals(type) && strs.length > 1){
			n = 1;
		}
