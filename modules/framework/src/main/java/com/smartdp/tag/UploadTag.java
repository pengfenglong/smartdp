...
public class UploadTag extends TagSupport {
	protected String id = "file";// ID
	protected String uploader;//url
	protected String name = "file";//控件名称
	...
	protected String queueID;//文件容器ID
	protected boolean dialog=false;//是否是弹出窗口模式
	protected String callback;
	protected boolean auto=true;//是否自动上传
	...
	public StringBuffer end() {
		...
		sb.append("<link rel=\"stylesheet\" href=\""+contexPath+"/framework/plugin/uploadify/css/uploadify.css\" type=\"text/css\"></link>");
		sb.append("<script type=\"text/javascript\" src=\""+contexPath+"/framework/plugin/uploadify/jquery.uploadify-3.1.js\"></script>");
		sb.append("<script type=\"text/javascript\" src=\""+contexPath+"/framework/plugin/tools/Map.js\"></script>");
		...
		sb.append("fileObjName:\'"+name+"\',"
				+"fileTypeExts:\'"+extend+"\',"
				+"fileSizeLimit:\'3MB\',"
				+"swf:\'"+contexPath+"/framework/plugin/uploadify/uploadify.swf\',	"
				+"uploader:\'"+contexPath+uploader+"?jsessionid="+request.getSession().getId()+"',"				
...
//				sb.append("var win = frameElement.api.opener");
				sb.append("alert(d.msg);");
				sb.append("}");
				sb.append("},");
				sb.append("onFallback : function(){alert(\"您未安装FLASH控件，无法上传图片！请安装FLASH控件后再试\")},");
				sb.append("onSelectError : function(file, errorCode, errorMsg){");
				sb.append("switch(errorCode) {");
				sb.append("case -100:");
				sb.append("alert(\"上传的文件数量已经超出系统限制的\"+$(\'#"+id+"\').uploadify(\'settings\',\'queueSizeLimit\')+\"个文件！\");");
				sb.append("break;");
				sb.append("case -110:"
