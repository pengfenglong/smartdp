 ...
 */
	...
	,	defaults: { // default options for 'all panes' - will be overridden by 'per-pane settings'
		...
		,	togglerLength_open:		20			// Length = WIDTH of toggler button on north/south edges - HEIGHT on east/west edges
		,	togglerLength_closed: 	20			// 100% OR -1 means 'full height/width of resizer bar' - 0 means 'hidden'
