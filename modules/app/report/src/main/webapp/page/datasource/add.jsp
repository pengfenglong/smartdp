...
<script type="text/javascript">
	...
	$(function(){
	    ...
	    $("#dsProperties").val("jdbc.driverClassName=com.microsoft.sqlserver.jdbc.SQLServerDriver#jdbc.url=jdbc:sqlserver://localhost:1433;DatabaseName=sample#jdbc.username=sa#jdbc.password=");
	    $("#propertyRegex").val("#");
...
<body>
	<form class="cmxform" action="${ctx}/rae/saveDatasourceConfig.action" method="POST">
		...
		<legend class="ui-widget ui-widget-header ui-corner-all">新增数据源</legend>
		<p>
        ...
        <p>
				<s:textarea id="dsProperties" label="配置" name="datasourceConfig.dsProperties"
					cols="20" rows="10" cssClass="required ui-widget-content width200px" />
			</p>
                        
        <p><s:select label="分隔符" id="propertyRegex" list="{';','#',','}"
