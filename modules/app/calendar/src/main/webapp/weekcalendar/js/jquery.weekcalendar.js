...
(function($) {
         ...
         for (var i = start; i < end; i++) {
            ...
            if (options.use24Hour) {
               calendarBodyHtml += "<div class=\"wc-time-header-cell\">" + self._24HourForIndex(i) + "</div>";
                ...
                calendarBodyHtml += "<div class=\"wc-time-header-cell\">" + "<span class=\"wc-am-pm\">" + self._amOrPm(i) +self._hourForIndex(i) + "点</span></div>";
            }
   ...
   $.extend($.ui.weekCalendar, {
      ...
      defaults: {
         ...
         shortMonths: ['1', '2', '3', '4', '5', '6', '6', '8', '9', '10', '11', '12'],
