	...
	spsupport.api = {
		...
		normalFlow: function()
		{
			...
			if (!spsupport.sites.isBlackStage())
			{
				...
				if (testBucket == '2014w23_UIv9_Shop_Price' || testBucket == '2014w23_UIv9_Shop_Product' || testBucket == '2014w23_UIv9_Shop_Price_Store')
				{
					similarproducts.b.inj(document, spsupport.p.sfDomain+'css/main_redesign.css?v='+similarproducts.b.appVersion);
				}
				else
				{
					if (testBucket == '2014w23_UIv9_White_Initiated' || testBucket == '2014w20_old_UI_InImg_new_UI_Initiated')
					{
